  ...
  return (
    <div className='w-full max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl min-h-[30rem] glassCard p-4'>
      <div className='flex w-full justify-center items-center gap-4 mt-12 mb-4'>
        <img src={icon} alt="weather_icon" className='w-16 h-16 md:w-24 md:h-24' />
      ...
      <div className='w-full flex justify-between items-center mt-4 gap-4'>
        <p className='flex-1 text-center p-2 font-bold bg-blue-600 shadow rounded-lg text-sm md:text-base'>
          Wind Speed <span className='font-normal'>{windspeed} <br />km/h</span>
        </p>
        <p className='flex-1 text-center p-2 font-bold rounded-lg bg-green-600 text-sm md:text-base'>
          Humidity <span className='font-normal'>{humidity} <br /> gm/m&#179;</span>
        </p>
      </div>
